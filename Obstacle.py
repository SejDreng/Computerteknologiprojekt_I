...
def getAndUpdateColour():
    ...
    green = data[1] + data[0]/256 # We read the incoming bytes of data and divide by 256 to bit-shift 8 times
    red = data[3] + data[2]/256 # It's only the least significant we need shift
